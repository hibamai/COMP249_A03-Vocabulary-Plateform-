...
public class Driver {
  ...
  public static DoublyLinkedList createDoublyLinkedList(ArrayList<String> topicArr) {
...
public static ArrayList<String> wordsFromFile(String file) {
    ...
    try {
        inputFile = new Scanner(new FileInputStream("COMP249_A03/src/DriverPackage/" + file));
  ...
  public static void addWordsToTopics(DoublyLinkedList topicList, ArrayList<String> topicArr, ArrayList<String> wordArr) {
        ...
        int choiceInt = 0;
            ...
            switch (choiceInt) {
                ...
                case 8: //show all words starting with a given letter
                    System.out.print("Enter the first letter of the words you want to display: ");
                ...
                case 9: //save to file
                    ...
                    try {
                        PrintWriter outPutFile = new PrintWriter(new FileOutputStream("COMP249_A03/src/DriverPackage/" + fileSave));
                        for (int i = 0; i < topicArr.size(); i++) {
                            Vocab vocab = topicList.getVocab(topicArr.get(i));
